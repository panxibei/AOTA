...
class pdreportController extends Controller
{
	...
	public function tongjiGets(Request $request)
	{
		...
		if (Cache::has($fullUrl)) {
			...
			$tongji = Smt_pdreport::select('shengchanriqi', 'xianti', 'dengdaibupin', 'wujihua', 'qianhougongchengdengdai', 'wubupin', 'bupinanpaidengdai', 'dingqidianjian', 'guzhang', 'shizuo')

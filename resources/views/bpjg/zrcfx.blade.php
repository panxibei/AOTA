	...
	<Tabs type="card" v-model="currenttabs" :animated="false">
		<Tab-pane label="机种/部品关系表">
			...
			<i-row :gutter="16">
				...
				<i-col span="4">
					导出：&nbsp;&nbsp;&nbsp;&nbsp;
					<Poptip confirm title="确定要导出后台数据吗？" placement="right-start" @on-ok="exportData_relation" @on-cancel="" transfer="true">
		...
		<Tab-pane label="部品信息">
			...
			<i-row :gutter="16">
				...
				<i-col span="4">
					导出：&nbsp;&nbsp;&nbsp;&nbsp;
					<Poptip confirm title="确定要导出后台数据吗？" placement="right-start" @on-ok="exportData_result" @on-cancel="" transfer="true">

...
<div id="app" v-cloak>
	...
	<Tabs type="card" v-model="currenttabs" :animated="false">
		...
		<Tab-pane label="生产信息录入">
			...
			<i-row :gutter="16">
				<i-col span="24">
					<i-table ref="planresult" :row-class-name="rowClassName_planresult" height="200" size="small" border no-data-text="请选择 计划日期、线体 和 班次 来查询计划！" :columns="tablecolumns_planresult" :data="tabledata_planresult" @on-row-click="(selection, index) => onselectchange_planresult(selection, index)"></i-table>
					&nbsp;
				</i-col>
			</i-row>
			<br><br>

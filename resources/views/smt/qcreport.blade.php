...
var vm_app = new Vue({
	...
	data: {
		...
		// saomiao: '66-41448Z67/C91S00123020890300/16',
		saomiao: '',
		lotshu: '',
	...
	methods: {
		...
		onchart3 () {
			...
			if (current_month > 2) {
				...
				var qcdate_filter = [new Date(last_year + '-04-01 00:00:00'), new Date(current_year + '-12-31 23:59:59')];
				_this.chart3_option_xAxis_data[0] = 'FY' + last_year + '平均';
			} else {
				// 如果当前是2020-03-30，则日期范围为
				// 去年：2018-04-01 ~ 2019-03-31
				// 今年：2019-04-01 ~ 2020-03-31
				var qcdate_filter = [new Date(before_last_year + '-04-01 00:00:00'), new Date(current_year + '-03-31 23:59:59')];
				_this.chart3_option_xAxis_data[0] = 'FY' + before_last_year + '平均';
			}
			...
			.then(function (response) {
				...
				if (response.data) {
					...
					_this.chart3_option_series_data_huizong[0] = Math.ceil(_this.chart3_option_series_data_huizong[0] / 12);
					// console.log(Math.ceil(_this.chart3_option_series_data_huizong[0]));
		...
		exportData_tongji () {
			...
			_this.$refs.table2.exportCsv({
				...
				columns: [
					...
					{title: 'SMT-4', key: 'hejidianshu4'}, {title: '', key: 'buliangjianshu4'}, {title: '', key: 'hejitaishu4'}, {title: '', key: 'ppm4'}, {title: 'SMT-5', key: 'hejidianshu5'}, {title: '', key: 'buliangjianshu5'}, {title: '', key: 'hejitaishu5'}, {title: '', key: 'ppm5'},{title: 'SMT-6', key: 'hejidianshu6'}, {title: '', key: 'buliangjianshu6'}, {title: '', key: 'hejitaishu6'}, {title: '', key: 'ppm6'},

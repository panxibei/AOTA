		...
		<Tab-pane label="品质管理日报">
			...
			<Tabs type="card" v-model="currentsubtabs" :animated="false">
				<Tab-pane label="品质管理日报">
					...
					<i-row :gutter="16">
						<i-col span="24">
							<i-table ref="table2" height="200" size="small" border :columns="tablecolumns2" :data="tabledata2"></i-table>
							<br><br>
...
tablecolumns2:[
	...
	},
	{
		...
		},
		{
            ...
            align:'center',
            render: (h, params) => {
              if(params.row.list[0].normal_amount!=undefined){
                return h('div', {
                  attrs: {
                      class:'subCol'
                  },
        ...
        },
        {
            ...
            align:'center',
            render: (h, params) => {
              if(params.row.list[0].be_late_amount!=undefined){
                return h('div', {
                  attrs: {
                      class:'subCol'
                  },
        ...
        },
        {
            ...
            align:'center',
            render: (h, params) => {
              if(params.row.list[0].leave_early_amount!=undefined){
                  return h('div', {
                    attrs: {
                        class:'subCol'
                    },
        ...
        },
        {
            ...
            align:'center',
            render: (h, params) => {
              if(params.row.list[0].not_attendance_amount!=undefined){
                return h('div', {
                  attrs: {
                      class:'subCol'
                  },

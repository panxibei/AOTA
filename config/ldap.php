...
return [
    ...
    */
    ...
    /*
    | 自己添加的，是否启用connection_01。
    */
    'ldap_use_connection_01' => env('LDAP_USE_CONNECTION_01', 'no use connection_01'),

    /*
    | 自己添加的，是否启用connection_02。
    */
    'ldap_use_connection_02' => env('LDAP_USE_CONNECTION_02', 'no use connection_02'),
    ...
    'connections' => [
        ...
        'connection_01' => [
            ...
            */
            ...
            'auto_connect' => env('LDAP_AUTO_CONNECT_01', true),
            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'account_prefix' => env('LDAP_ACCOUNT_PREFIX_01', ''),
                ...
                */
                ...
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX_01', ''),
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS_01', 'corp-dc1.corp.acme.org corp-dc2.corp.acme.org')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN_01', 'dc=corp,dc=acme,dc=org'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME_01'),
                'password' => env('LDAP_PASSWORD_01'),
                ...
                */
                ...
                'use_ssl' => env('LDAP_USE_SSL_01', false),
                'use_tls' => env('LDAP_USE_TLS_01', false),
